/**
 * Yahoo Finance 行情抓取 —— 移植自 gzinfo lib/trading/yahoo.ts。
 * 2.0：IO 归适配器层（服务层只依赖 HttpClient 端口），类型上移 contracts/market.ts。
 */
import type { OHLC, TickerRawData } from "../contracts/market";
